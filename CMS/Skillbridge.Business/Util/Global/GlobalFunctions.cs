...
namespace Skillbridge.Business.Util.Global
{
    public static class GlobalFunctions
    {
        ...
        public static int FindNumStatesInProgram(ProgramModel prog, ApplicationDbContext _db)
        {
            // Update Program
            string newStateList = "";
            int num = 0;
        ...
        public static void UpdateOrgStatesOfProgramDelivery(OrganizationModel org, ApplicationDbContext _db)
        {
        ...
        public static void UpdateStatesOfProgramDelivery(ProgramModel prog, List<OpportunityModel> opps, ApplicationDbContext _db)
        {
            // Update Program
            string newStateList = "";
            int num = 0;
        ...
        public static void UpdateProgramLocationDetailsAvailable(ProgramModel prog, ApplicationDbContext _db)
        {
        ...
        public static void UpdateJobFamilyListForOpps(ProgramModel prog, List<OpportunityModel> opps, ApplicationDbContext _db)
        {
