...
{
    public class ListOpportunityModel
    {
        ...
        public string Mou_Link { get; set; }
        ...
        <td>@opp.MOU_Link</td>
        <td>@opp.MOU_Expiration_Date</td>
        <td>@opp.Employer_Poc_First_Name</td>
        <td>@opp.Employer_Poc_Last_Name</td>
