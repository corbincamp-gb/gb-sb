...
namespace Skillbridge.Business.Model.Db
{
    public class ProgramModel
    {
        ...
        public string Intake_Form_Version { get; set; } =
        ...
        [Display(Name = "Has Consent")] public bool Has_Consent { get; set; }
        ...
        [Display(Name = "Services Supported")] public string Services_Supported { get; set; } = "";
        [Display(Name = "Enrollment Dates")] public string Enrollment_Dates { get; set; } = "";
        ...
        [Display(Name = "Created By")] public string Created_By { get; set; }
        [Display(Name = "Updated By")] public string Updated_By { get; set; }
        ...
        [Display(Name = "For Spouses")] public bool For_Spouses { get; set; }
