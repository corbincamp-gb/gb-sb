...
// THIS FILE WAS LITERALLY COPIED FROM https://learn.microsoft.com/en-us/sharepoint/dev/sp-add-ins/using-csom-for-dotnet-standard
...
namespace SkillBridgeConsoleApp
{
    public class SharepointAuthenticationManager : IDisposable
    {
        ...
        // **************************
        // ** CHANGE THIS TO YOUR ORGANIZATION'S SPECIFIC APP ID
        // **************************
        private const string defaultAADAppId = "9f770f8a-9d0a-4d6e-bb6a-db119b8cbe22";
